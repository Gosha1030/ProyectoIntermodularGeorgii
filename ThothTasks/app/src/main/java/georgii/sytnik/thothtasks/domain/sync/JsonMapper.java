...
public final class JsonMapper {
    ...
    public static JSONObject taskToJson(TaskEntity t) throws JSONException {
        ...
        o.put("taskId", MessageCodec.hex(t.taskId));
        o.put("fatherId", t.taskFather != null ? MessageCodec.hex(t.taskFather) : JSONObject.NULL);
    ...
    public static JSONObject taskChangeToJson(TaskChangeEntity c) throws JSONException {
        JSONObject o = new JSONObject();
        o.put("id", MessageCodec.hex(c.taskChangeId));
        o.put("taskId", MessageCodec.hex(c.taskId));
        o.put("newTaskId", c.newTaskId != null ? MessageCodec.hex(c.newTaskId) : JSONObject.NULL);
        o.put("type", c.type);
